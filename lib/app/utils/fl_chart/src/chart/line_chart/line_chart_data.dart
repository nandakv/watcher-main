...
import '../../../../fl_chart/src/extensions/color_extension.dart';
import '../../../../fl_chart/src/extensions/gradient_extension.dart';
...
List<TouchedSpotIndicatorData> defaultTouchedIndicators(
  ...
  List<int> indicators,
    ...
    indicators.map((int index) {
      /// Indicator Line
      var lineColor = verifiedGreenColor;
      if (barData.dotData.show) {
        lineColor = verifiedGreenColor;
      }
      const lineStrokeWidth = 1.0;
      final flLine = FlLine(
          color: lineColor, strokeWidth: lineStrokeWidth, dashArray: [2]);
      ...
      final dotData = FlDotData(
        getDotPainter: (spot, percent, bar, index) =>
            _defaultGetDotPainter(spot, percent, bar, index, size: dotSize,isSelected: isSelected),
      );
