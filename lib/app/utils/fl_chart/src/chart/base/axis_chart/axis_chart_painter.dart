...
import 'package:privo/app/utils/fl_chart/src/extensions/paint_extension.dart';
  ...
  double getTooltipLeft(
    ...
    switch (tooltipHorizontalAlignment) {
      case FLHorizontalAlignment.center:
        result = dx - (tooltipWidth / 2) + tooltipHorizontalOffset;
        break;
      case FLHorizontalAlignment.right:
        result = dx + tooltipHorizontalOffset;
        break;
      case FLHorizontalAlignment.left:
        result = dx - tooltipWidth + tooltipHorizontalOffset;
        break;
      default:
        throw ArgumentError('Invalid tooltipHorizontalAlignment value');
    }
