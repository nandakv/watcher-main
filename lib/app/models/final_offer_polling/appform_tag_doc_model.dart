...
AppFormTagDocModel appFormTagModelFromJson(ApiResponse apiResponse) {
  return AppFormTagDocModel.decodeResponse(apiResponse);
}

class AppFormTagDocModel {
  late final TaggedDoc taggedDoc;
  late final ApiResponse apiResponse;
  late final List<AllowedDocType> docs;

  AppFormTagDocModel.decodeResponse(ApiResponse apiResponse) {
  ...
  _parseJson(String apiResponse) {
    ...
    docs =  [AllowedDocType.fromJson({'id':json['id'],'name':json['fileName']})];
  }
}
