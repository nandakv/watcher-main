...
class EmandateFailureWidget extends StatelessWidget {
  EmandateFailureWidget({Key? key}) : super(key: key);

  var logic = Get.find<EMandateLogic>();
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              const Spacer(),
              logic.shouldShowHelpMessage() ?   Container(
